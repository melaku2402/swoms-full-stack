...
export default RulesController;// Calculate overload payment (NEW)
    static async calculateOverloadPayment(req, res) {
      try {
...
export default WorkloadReportController;// export default WorkloadRPController;
import { query } from "../config/database.js";
import { sendSuccess, sendError } from "../utils/response.js";
...
export default WorkloadNRPService;// src/services/WorkloadReportService.js
import { query } from "../config/database.js"; 
import {
  PROGRAM_TYPES,
  NRP_PROGRAM_TYPES,
...
export default RulesController;import express from "express";
...
router.get("/alerts", authorize("department_head", "admin", "hr_director", "dean"), 
