...
//     const rpWorkloads = workloads.rp || [];
...
//       totalHours: rpWorkloads.reduce((sum, w) => sum + (w.total_load || 0), 0),
//       totalPayment: rpWorkloads.reduce(
//         (sum, w) => sum + (w.over_payment_birr || 0),
//         0
//       ),
//     });
//   };
...
//     try {
//       await submitWorkloadForApproval("rp", id);
...
//         icon: CheckCircle,
//       },
//       vpaa_approved: { color: "bg-pink-100 text-pink-800", icon: CheckCircle },
...
//                   {workload.total_credit_hours?.toFixed(1) || "0.0"}
//                 </p>
//               </div>
//               <div>
//                 <p className="text-xs text-gray-500 mb-1">Student Count</p>
//                 <p className="text-sm font-medium text-gray-900">
//                   {workload.student_count || "N/A"}
//                 </p>
//               </div>
//               <div>
//                 <p className="text-xs text-gray-500 mb-1">Overload Payment</p>
//                 <p className="text-sm font-medium text-emerald-600">
//                   ${workload.over_payment_birr?.toLocaleString() || "0"}
//                 </p>
//               </div>
//             </div>
//           </div>
...
//               Total: {workload.total_load?.toFixed(1) || 0}h
//             </span>
//           </div>
...
//               style={{
//                 width: `${
//                   ((workload.research_load || 0) / workload.total_load) * 100 ||
//                   0
//                 }%`,
//               }}
//               title="Research Load"
...
//               style={{
//                 width: `${
//                   ((workload.elip_load || 0) / workload.total_load) * 100 || 0
//                 }%`,
//               }}
...
//                 </button>
//                 <button
//                   onClick={() => handleSubmitForApproval(workload.workload_id)}
...
//             {workload.status === "draft" && (
//               <button
//                 onClick={() => setShowDeleteModal(workload.workload_id)}
...
//           <p className="text-gray-600">Loading RP workloads...</p>
//         </div>
//       </div>
//     );
//   }
...
//                 Regular Program Workload
//               </h1>
//               <p className="text-blue-100">
//                 Manage your regular program teaching workload
//               </p>
//             </div>
//             <div className="flex items-center space-x-3 mt-4 md:mt-0">
//               <button
//                 onClick={() => fetchRPWorkloads()}
//                 className="px-4 py-2 bg-white/20 hover:bg-white/30 rounded-lg flex items-center space-x-2 transition-colors"
//               >
//                 <RefreshCw className="h-4 w-4" />
//                 <span>Refresh</span>
//               </button>
//               <button className="px-4 py-2 bg-white hover:text-blue-600 text-blue-600 rounded-lg flex items-center space-x-2 transition-colors">
...
//                 <input
//                   type="text"
//                   placeholder="Search workloads by course code or title..."
...
//                   : "You haven't created any RP workloads yet"}
//               </p>
//               <button className="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors flex items-center space-x-2 mx-auto">
...
//                       </label>
//                       <p className="text-gray-900">
//                         {showDetailsModal.semester_name}
//                       </p>
//                     </div>
//                     <div>
//                       <label className="block text-sm font-medium text-gray-700 mb-1">
...
//                       </label>
//                       <p className="text-gray-900">
//                         {showDetailsModal.academic_year}
//                       </p>
//                     </div>
//                     <div>
//                       <label className="block text-sm font-medium text-gray-700 mb-1">
...
//                       </label>
//                       <p className="text-gray-900">
//                         {showDetailsModal.total_load?.toFixed(1) || 0} hours
//                       </p>
//                     </div>
//                     <div>
//                       <label className="block text-sm font-medium text-gray-700 mb-1">
...
//                       </label>
//                       <p className="text-gray-900">
//                         {showDetailsModal.number_of_sections || 1}
//                       </p>
//                     </div>
//                     <div>
//                       <label className="block text-sm font-medium text-gray-700 mb-1">
...
//                       </label>
//                       <p className="text-gray-900">
//                         {showDetailsModal.total_credit_hours?.toFixed(1) || 0}
//                       </p>
//                     </div>
//                   </div>
//                 </div>
...
//                       {(
//                         (showDetailsModal.each_section_course_load || 0) *
//                         (showDetailsModal.number_of_sections || 1)
//                       ).toFixed(1)}
//                       h
//                     </p>
...
//                       {(showDetailsModal.research_load || 0).toFixed(1)}h
//                     </p>
//                   </div>
...
//                       {(showDetailsModal.community_service_load || 0).toFixed(
//                         1
//                       )}
//                       h
//                     </p>
...
//                       {(showDetailsModal.elip_load || 0).toFixed(1)}h
//                     </p>
//                   </div>
//                 </div>
//               </div>
...
//               <p className="text-gray-600 mb-6">
//                 Are you sure you want to delete this workload? This action
//                 cannot be undone.
//               </p>
...
// src/pages/workload/RegularProgramWorkload.jsx
import React, { useState, useEffect } from 'react';
...
const RegularProgramWorkload = () => {
  ...
  const fetchWorkloads = async () => {
    try {
      setLoading(true);
      const response = await workloadAPI.getRPWorkload();
      ...
      const statsData = {
        ...
        approved: workloadsData.filter(w => 
          ['dh_approved', 'dean_approved', 'hr_approved', 'vpaa_approved', 'vpaf_approved', 'finance_approved'].includes(w.status)
        ).length
      };
      setStats(statsData);
      
    } catch (error) {
      console.error('Error fetching RP workloads:', error);
  ...
  const filterWorkloads = () => {
    ...
    if (filters.search) {
      ...
      filtered = filtered.filter(w =>
        ...
        w.student_department?.toLowerCase().includes(searchLower)
      );
    }
  ...
  const handleSubmitForApproval = async (workloadId) => {
    try {
      await workloadAPI.submitRPWorkload(workloadId);
      toast.success('Workload submitted for approval');
      fetchWorkloads();
    } catch (error) {
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading RP workloads...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Regular Program (RP) Workload</h1>
          <p className="text-gray-600 mt-1">
            Manage your regular program teaching workload and administrative duties
          </p>
        </div>
        <div className="flex items-center space-x-3">
          <Link
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredWorkloads.length > 0 ? (
                filteredWorkloads.map((workload) => (
                  <tr key={workload.workload_id} className="hover:bg-gray-50">
                    <td className="px-6 py-4">
                      <div>
                        ...
                        <div className="flex items-center mt-2 text-sm text-gray-500">
                          ...
                          {workload.academic_year || 'N/A'} • {workload.number_of_sections || 1} sections
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="space-y-1">
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Course Load:</span>
                          <span className="font-medium">
                            {formatNumber(workload.each_section_course_load * (workload.number_of_sections || 1))}h
                          </span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Research/Service:</span>
                          <span className="font-medium">
                            {formatNumber((workload.research_load || 0) + (workload.community_service_load || 0))}h
                          </span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">Total Load:</span>
                          <span className="font-bold text-gray-900">
                            {formatNumber(workload.total_load)}h
                          </span>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex flex-col space-y-1">
                        <span className={`px-3 py-1 rounded-full text-xs font-medium text-center ${getStatusColor(workload.status)}`}>
                          {getStatusText(workload.status)}
                        </span>
                        {workload.over_payment_birr > 0 && (
                          <span className="text-xs text-green-600 font-medium text-center">
                            +{formatNumber(workload.over_payment_birr)} ETB
                          </span>
                        )}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex items-center space-x-2">
                        <Link
                          to={`/workload/rp/${workload.workload_id}`}
                        ...
                        {workload.status === 'draft' && (
                          <>
                            <Link
                              to={`/workload/rp/${workload.workload_id}/edit`}
                        ...
                        {workload.status === 'submitted' && (
                          <button
                            onClick={() => workloadAPI.getApprovalStatus(workload.workload_id, 'rp')}
                ...
                <tr>
                  <td colSpan="5" className="px-6 py-12 text-center">
                    ...
                    <p className="text-gray-500">No RP workloads found</p>
                    ...
                    {workloads.length === 0 && (
                      ...
                      >
                        <Plus className="h-4 w-4" />
                        <span>Create Your First RP Workload</span>
                      </Link>
                    )}
                  </td>
                </tr>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-100 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <p className="font-medium text-gray-900">Create New RP Workload</p>
            <p className="text-sm text-gray-500">Add regular program workload</p>
          </Link>
          ...
          >
            ...
            <p className="font-medium text-gray-900">View Workload Summary</p>
            <p className="text-sm text-gray-500">See complete overview</p>
          </Link>

          <button
            onClick={() => toast.info('Load calculator coming soon')}
          ...
          >
            ...
            <p className="font-medium text-gray-900">Calculate Load</p>
            <p className="text-sm text-gray-500">Estimate your workload</p>
          </button>
        </div>
      </div>
    </div>
...
export default RegularProgramWorkload;